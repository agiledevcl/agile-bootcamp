...
<body>	
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h4 class="text-center">Para entrar al sistema haz click en Clave &Uacute;nica</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12 text-center">
				<a href="system/loginOauth2CU"><img class="btn" src="<c:url value='/resources/imgs/claveunica.png'/>"></
			</div>
		</div>
	</div>
